  ...
  return (
    <div className="gig">
      ...
      <div className="container">
        <div className="left">
          <span className="breadcrumbs">Liverr {">"} {data.cat} {">"}</span>
          <h1>{data.title}</h1>
          {userIsLoading ? "loading" : userError ? "something went wrong" : (<div className="user">
            <img
              className="pp"
          ...
          <p>{data.desc}</p>
          {userIsLoading ? "loading" : userError ? "something went wrong" : (<div className="seller">
